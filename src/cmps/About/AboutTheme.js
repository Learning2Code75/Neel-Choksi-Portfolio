...
const AboutTheme = ({ state, setState }) => {
  return (
    <div className="themeGrid">
      <div className="tgComp">
        ...
        <SketchPicker
          color={state.theme.aboutCompBackground}
          onChange={(newColor) => {
            setState({
              ...state,
              theme: {
                ...state.theme,
                aboutCompBackground: newColor.rgb,
              },
            });
      ...
      <div className="tgComp">
        ...
        <button
          className="btn-sm"
          onClick={() => {
            setState({ ...state, ui: "aboutCompUI1" });
          }}
        >
          UI 1
        </button>
        <button
          className="btn-sm"
          onClick={() => {
            setState({ ...state, ui: "aboutCompUI2" });
          }}
        >
          UI 2
        </button>
        <button
          className="btn-sm"
          onClick={() => {
            setState({ ...state, ui: "aboutCompUI3" });
          }}
        >
          UI 3
        </button>
        <button
          className="btn-sm"
          onClick={() => {
            setState({ ...state, ui: "aboutCompUI4" });
          }}
        >
          UI 4
        </button>
